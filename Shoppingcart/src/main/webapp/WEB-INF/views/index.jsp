...
<body>
	...
	<div class="container text-center">
		...
		<div class="row">
			<div class="col-sm-4">
				<img src="resources/carousel/lenovo-p2.jpg" class="img-responsive"
					style="width: 100%" alt="Image">
				<p>Lenovo P2</p>
			</div>
			<div class="col-sm-4">
				<img src="resources/carousel/pixel1.png" class="img-responsive"
					style="width: 100%" alt="Image">
				<p>Google Pixel</p>
			</div>
			<div class="col-sm-4">
	...
	<p>Mail Us: Flipkart Internet Private Limited, Ozone Manay Tech
		Park, #56/18 & 55/09, 7th Floor, Garvebhavipalya, Hosur Road,
		Bangalore - 560068, Karnataka, India.</p>
	</footer>
